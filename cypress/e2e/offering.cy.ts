...
const interceptors = (productSpec:any, productOfferingPOST:any, newCatalog:any, defaultCatalog: any, defaultCategory:any, offPricePOST:any) => {
    ...
    cy.intercept({method: 'GET', url: 'https://tmf.evidenceledger.eu/tmf-api/productCatalogManagement/v4/catalog?*'}, (res)=>{
        res.reply({
            statusCode: 200,
            body: sr[scall++]
        })
    }).as('catalogs')
    cy.intercept({method: 'GET', url: 'https://tmf.evidenceledger.eu/tmf-api/productCatalogManagement/v4/productOffering?*'}, (res)=>{
        res.reply({
            statusCode: 200,
            body: response[call++]
        })
    }).as('productOff')
    cy.intercept({method: 'GET', url: 'https://tmf.evidenceledger.eu/tmf-api/productCatalogManagement/v4/productSpecification?*'}, (res)=>{
        res.reply({
            statusCode: 200,
    ...
    cy.intercept({method: 'GET', url: 'https://tmf.evidenceledger.eu/tmf-api/productCatalogManagement/v4/catalog/urn:ngsi-ld:catalog:32828e1d-4652-4f4c-b13e-327450ce83c6'}, (res)=>{
        res.reply({
            statusCode: 200,
            body: defaultCatalog
        })
    ...
    cy.intercept({method: 'GET', url: 'https://tmf.evidenceledger.eu/tmf-api/productCatalogManagement/v4/category/urn:ngsi-ld:category:26435cca-2707-4c89-8f0c-79464573c9e2'}, (res)=>{
        res.reply({
            statusCode: 200,
    ...
    cy.intercept({method: 'POST', url: `https://tmf.evidenceledger.eu/tmf-api/productCatalogManagement/v4/catalog/${newCatalog.id}/productOffering`}, {statusCode: 201, body: productOfferingPOST}).as('offPOST')
    if (offPricePOST){
        cy.intercept({method: 'POST', url: 'https://tmf.evidenceledger.eu/tmf-api/productCatalogManagement/v4//productOfferingPrice'}, {statusCode: 201, body: offPricePOST}).as('offPricePOST')
    }
