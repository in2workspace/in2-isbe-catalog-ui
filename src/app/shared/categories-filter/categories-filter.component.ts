...
export class CategoriesFilterComponent implements OnInit {
  ...
  classList      = 'flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200    hover:bg-gray-100  gap-3';
  ...
  labelClass: string = "text-gray-500 bg-white border-2 rounded-lg cursor-pointer   peer-checked:border-primary-50 hover:text-gray-600   peer-checked:text-gray-600 hover:bg-gray-50   ";
  categories: Category[] = [];
